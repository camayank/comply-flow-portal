    ...
    const services = [
      {
        ...
        description: 'Complete company incorporation with ROC including name approval, documentation, and certificate issuance',
      ...
      },
      {
        ...
        periodicity: 'ONE_TIME',
        description: 'Initial compliance setup within 30 days of incorporation including board meetings and statutory registers',
        category: 'incorporation'
      },
      {
        ...
        periodicity: 'ONE_TIME',
        description: 'GST registration with GSTN portal including document verification and certificate issuance',
        category: 'incorporation'
      },
      {
      ...
      },
      {
        ...
        periodicity: 'QUARTERLY',
        description: 'TDS calculation, payment, and quarterly return filing (24Q/26Q/27Q)',
        category: 'compliance'
      },
      {
      ...
      },
      {
        ...
        periodicity: 'ANNUAL',
        description: 'Annual income tax return preparation and filing for companies and individuals',
        category: 'annual'
      },
      {
        ...
        periodicity: 'ANNUAL',
        description: 'Annual financial statement preparation including Balance Sheet and P&L Account',
        category: 'accounting'
      }
    ];
