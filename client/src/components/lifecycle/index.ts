// Re-export lifecycle components from features folder
export { default as ProgressCard } from '@/features/client-portal/components/ProgressCard';
export { default as MetricCard } from '@/features/client-portal/components/MetricCard';
